...
The [`solidus_frontend`](https://github.com/solidusio/solidus/tree/master/frontend) storefront will be accessible at [http://localhost:4000/](http://localhost:4000/)
and the admin can be found at [http://localhost:4000/admin/](http://localhost:4000/admin/).
